...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    # Recettes
    $routes->connect('/' . __d('URL', 'recettes/creer'), ['controller' => 'Recipes', 'action' => 'add'], ['_name' => 'create_recipe_path']);
    $routes->connect('/' . __d('URL', 'mes-recettes'), ['controller' => 'Recipes', 'action' => 'index'], ['_name' => 'recipes_path']);
...
Router::prefix('admin', function ($routes) {
    $routes->connect('/', ['controller' => 'Pages', 'action' => 'home'], ['_name' => 'admin']);
